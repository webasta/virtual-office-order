...
class Wordpress_Custom_Plugin_Public {
    ...
    public function register_custom_plugin_redirect()
    {
        ...
        if (get_query_var('custom_plugin')) {
            add_filter('template_include', function () {
                return plugin_dir_path(__FILE__) . 'partials/virtual_office_order-public-index.php';
            });
		}
		// Check if its a detail page for a vehicle
        if (get_query_var('custom_plugin') && get_query_var('custom_plugin_vehicle')) {
            add_filter('template_include', function () {
                return plugin_dir_path(__FILE__) . 'partials/virtual_office_order-public-detail.php';
            });
        }
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/virtual_office_order-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/virtual_office_order-public.js', array( 'jquery' ), $this->version, false );
