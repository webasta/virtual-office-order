 ...
 * @subpackage Virtual_Office_Order/admin
 */
 ...
 */
class Virtual_Office_Order_Admin {
	...
	public function display_custom_plugin_admin_page(){
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/virtual_office_order-admin-display.php';
	}
	...
	public function display_custom_plugin_admin_page_two(){
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/virtual_office_order-admin-two-display.php';
	}
	...
	public function setup_sections() {
		add_settings_section( 'section_one', 'Section One', array($this, 'section_callback'), 'virtual_office_order-options' );
		add_settings_section( 'section_two', 'Section Two', array($this, 'section_callback'), 'virtual_office_order-options' );
	}
	...
	public function setup_fields() {
		...
		foreach( $fields as $field ){
			add_settings_field( $field['uid'], $field['label'], array($this, 'field_callback'), 'virtual_office_order-options', $field['section'], $field );
			register_setting( 'virtual_office_order-options', $field['uid'] );
		}
	}
	...
	public function enqueue_styles() {
		 ...
		 * defined in Virtual_Office_Order_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Virtual_Office_Order_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/virtual_office_order-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/virtual_office_order-admin.js', array( 'jquery' ), $this->version, false );
